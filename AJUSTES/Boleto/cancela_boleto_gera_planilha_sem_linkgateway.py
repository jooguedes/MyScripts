...
ID_PORTADOR = 10
CANCELAR = True
NOME_ARQUIVO = 'lista_boletos_cancelados_galaxpay.csv'
...
if CANCELAR:
    fmodels.Titulo.objects.filter(portador=ID_PORTADOR,
                                    ...
                                    .update(status=fmodels.MOVIMENTACAO_CANCELADA,
                                            ...
                                            motivocancela="Boleto cancelado mediante ocorrência importação-protocolo: 230508104802, autorizaddo pelo Sr(a). Antônio Jeverson.")
