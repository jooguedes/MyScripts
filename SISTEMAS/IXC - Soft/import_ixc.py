...
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --nas=ixc-nas.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --planos=ixc-planos.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --portadores=ixc-portadores.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --caixas=ixc-caixas.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --pops=ixc-pops.csv.utf8
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --clientes=ixc-clientes.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --titulos=ixc-titulos.csv.utf8
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --caixas=ixc-caixas.csv.utf8
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --clientes=ixc-clientes.csv
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --clientes=ixc-clientes-desativados.csv.utf8 ixc-clientes-semlogin.csv.utf8
# python import_ixc.py --settings=sgp.megafibrainfinity.settings --fornecedores=ixc-fornecedores.csv.utf8
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --usuarios=ixc-usuarios.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --historico=ixc-historico.csv.utf8 -sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --chamados=ixc-chamados.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --onutemplates=ixc-onutemplate.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --olts=ixc-olts.csv.utf8  --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --pons=ixc-pons.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --onus=ixc-onus.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --loginsonu=ixc-logins-onus.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --nf2122=ixc-nf2122.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --arquivos=ixc-clientes-arquivos.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --ctos=ixc-ctos.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --chamadoassuntos=ixc-ocorrenciatipo.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --planocontas=ixc-planocontas.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --pagar=ixc-pagar.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --titulosrenegociados=ixc-titulos-renegociados.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --setores=ixc-setor.csv.utf8 --sync=1
# python import_ixc.py --settings=sgp.megafibrainfinity.settings  --wifi=ixc-wifi-login-e-senha.csv --sync=1
#python import_ixc.py --settings=sgp.megafibrainfinity.settings  --alertas=ixc-wifi-login-e-senha.csv --sync=1
