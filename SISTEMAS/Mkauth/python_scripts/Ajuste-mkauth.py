...
if args.clientes:
    ...
    with open(args.clientes, 'rb') as csvfile:
        ...
        for row in conteudo:
            ri += 1
            idcontrato = int(row[0]) + add_id_cliente
            
                #'.mkauth_%s'%
            login= '%s%s'%(row[1], add_string_login)
            ...
            login_pai = '%s%s'%(row[49], add_string_login)
            ...
            if args.sync_db == True and admmodels.Cliente.objects.filter(pessoa__cpfcnpj__numfilter=cpfcnpj).count() == 0:
                ...
                if admmodels.ServicoInternet.objects.filter(login__trim__lower=login).count() > 0:
                    fmodels.Cobranca.objects.filter(clientecontrato__servicointernet__login__trim__lower=login).update(cliente=new_cliente)
                    admmodels.ClienteContrato.objects.filter(servicointernet__login__trim__lower=login).update(cliente=new_cliente)
...
if args.chamados:
    ...
    with open(args.chamados, 'rb') as csvfile:
        ...
        for row in conteudo:
            ...
            login = '%s%s'%(row[1].strip().lower(), add_string_login)
            assunto = row[2]
            status = row[3]
...
if args.coordenadas:
    with open(args.coordenadas, 'rb') as csvfile:
        ...
        for row in conteudo:
            print(row)
            login = '%s%s'%(row[0], add_string_login)
            print(admmodels.Endereco.objects.filter(servicointernet__login__iexact=login).update(map_ll=row[1]))
            print(admmodels.Endereco.objects.filter(cobranca__clientecontrato__servicointernet__login__iexact=login).update(map_ll=row[1]))
...
'''
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados.csv.utf8 --sync=1
	
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados2.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados2.csv.utf8 --sync=1

python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados3.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-ativados3.csv.utf8 --sync=1

python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-adicional.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-adicional.csv.utf8 --sync=1

python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-adicional2.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-adicional2.csv.utf8 --sync=1

python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-desativados.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --clientes=mkauth-clientes-desativados.csv.utf8 --sync=1

python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --coordenadas=mkauth-clientes-coordenadas.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --chamados=mkauth-chamados.csv.utf8
python Ajuste-mkauth.py --settings=sgp.vsetelecom.settings --nas=1 --pop=2 --portador=1 --vencimentoadd=1 --planoadd=1 --msg_chamados=mkauth-msg-ocorrencia.csv.utf8
'''
