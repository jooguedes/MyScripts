        ...
        try:
            ...
            for cliente in clientes:
                if titulos[t]['id_cliente']==clientes[cliente]['id']:
                    ...
                    usuario = authmodels.User.objects.get(username='sgp')
                    descricao = unicode(titulos[t]['descricao'].decode('latin-1'))
                    nosso_numero_f = None
                    ...
                    cancelado=str(titulos[t]['cancelado'])
                    print('o pago é: ', pago, 'o cancelado é: ',cancelado )
                    if pago =='false' and cancelado=='false':
                        print('Entrei no IF do Gerado')
                        data_pagamento = None
                        data_baixa = None 
                    ...
                    elif str(titulos[t]['cancelado'])=='true':
                    ...
                    if nosso_numero and str(titulos[t]['cancelado'])=='false':
                        print('esse é meu id de portador: ',titulos[t]['id_carteira'])
                        if(str(titulos[t]['id_carteira'].strip())=='6'):
                            id_portador=1
                        else:
                            print('Nenhum portador identificado')
                            continue
