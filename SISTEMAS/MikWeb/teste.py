...
#########################IMPORT GERAL################################
#python import_perfacio_titulos.py --settings=sgp.stoynet.settings --nas=1 --planoadd=1 --clientes=Conv-clientes-perfacio.csv --titulos=Conv-recebiveis-perfacio.csv --sync=1
