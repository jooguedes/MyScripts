...
where cp.deleted = 'f'
) TO '/tmp/synsuit-empresas.csv' DELIMITER '|' csv HEADER;
...
where ba.deleted = 'f'
) TO '/tmp/synsuit-portadores.csv' DELIMITER '|' csv HEADER;
...
) TO '/tmp/synsuit-clientes.csv' DELIMITER '|' csv HEADER;

-- 630	Pelo CE	alojamento@mtealto	ServerPPPOE	Base-MteAlto	Normal					
-- 631	Pelo CE	refeitorio@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 632	Pelo CE	jacto@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 633	Pelo CE	defensivo@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 634	Pelo CE	balanca@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 635	Pelo CE	diego@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 636	45.6.200.48	escritorio@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 637	Pelo CE	stamaria@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 638	Pelo CE	aguabranca@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 639	Pelo CE	elvio@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 640	45.6.200.49	sonia@mtealto	ServerPPPOE	ServerPPPOE	Normal					
-- 2048	Pelo CE	junior@mtealto	ServerPPPOE	ServerPPPOE	Normal	30/11/2018 11:13				
-- 2831	Pelo CE	alojamento2@mtealto	ServerPPPOE	ServerPPPOE	Normal	18/08/2021 14:44				
-- 3208	45.6.200.93	postcombustivel@mtealto	ServerPPPOE	ServerPPPOE	Normal	27/01/2023 15:05
...
) TO '/tmp/synsuit-titulos-areceber.csv' DELIMITER '|' csv HEADER;
...
left join financial_receipt_titles fr on (fr.financial_receivable_title_id = ft.id) 
where ft.deleted = 'f' and ft.bank_account_id = ''
) TO '/tmp/synsuit-titulos-areceber-sembanco.csv' DELIMITER '|' csv HEADER;
...
) TO '/tmp/synsuit-fornecedores.csv' DELIMITER '|' csv HEADER;
...
where ft.deleted = 'f'
) TO '/tmp/synsuit-contas-a-pagar.csv' DELIMITER '|' csv HEADER;
...
where a.deleted = 'f'
) TO '/tmp/synsuit-ocorrencias.csv' DELIMITER '|' csv HEADER;
...
) TO '/tmp/synsuit-notasfiscais.csv' DELIMITER '|' csv HEADER;
